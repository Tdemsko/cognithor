...
class SandboxConfig:
    ...
    # Filesystem
    workspace_dir: Path = field(default_factory=lambda: Path.home() / ".cognithor" / "workspace")
...
class WindowsJobObjectSandbox:
    ...
    # Win32 Constants — imported at method level from cognithor.utils.win32_job
    ...
    async def execute(
        ...
        from cognithor.utils.win32_job import (
